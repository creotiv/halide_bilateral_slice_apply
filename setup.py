...
class HalidePyTorchExtension(setuptools.Extension):
    ...
    def __init__(self, halide_root, name, *args, generators=[], 
                 gen_cxx="c++", gen_cxxflags=None, extra_sources=[], **kwargs):
    ...
    def _get_gen_deps(self, flags, hl_distrib):
        ...
        if flags is None:
            flags = [os.path.join(hl_distrib, "lib", "libHalide"+ext),
        ...
        for ext in exts:
            if isinstance(ext, HalidePyTorchExtension):
                ...
                for g in generators:
                    ...
                    cmd = cxx + cxxflags + [g] + gendeps + ["-o", generator_bin] + ldflags + hlsyslibs + inc
...
generators = [
            ...
            HalideOp("bilateral_slice_apply_grad.cpp", "bsa_grad",
...
setuptools.setup(name='bilateral_slice_apply',
      ext_modules=[HalidePyTorchExtension(
          '/home/creotiv/work/libs/Halide-10.0.0-x86-64-linux/',
          'bilateral_slice_apply', 
          generators=generators, 
          include_dirs=["/home/creotiv/work/libs/Halide-10.0.0-x86-64-linux/include/"],
          libraries=["/home/creotiv/work/libs/Halide-10.0.0-x86-64-linux/lib/"],
          gen_cxxflags=["-std=c++14"])],
      cmdclass={'build_ext': HalideBuildExtension})

shutil.copy('./build/lib.linux-x86_64-3.8/bilateral_slice_apply.cpython-38-x86_64-linux-gnu.so','./bilateral_slice_apply.cpython-38-x86_64-linux-gnu.so')

# sudo apt-get install libtinfo-dev 

# TORCH_USE_RTLD_GLOBAL=YES python3

# https://github.com/halide/Halide/blob/master/apps/HelloPyTorch/src/add_generator.cpp
